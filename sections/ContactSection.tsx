      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          <a
            ...
            className="contact-card group relative cursor-pointer rounded-2xl overflow-hidden bg-white dark:bg-[#1B2731] shadow-lg hover:shadow-xl border border-gray-200 dark:border-gray-700 p-6 transition-all duration-300 hover:border-blue-500 dark:hover:border-blue-400 hover:-translate-y-2"
          >
            ...
            <div className="relative flex flex-col items-center gap-4">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-md transition-transform duration-300 group-hover:scale-110 group-hover:shadow-lg">
                <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <div className="text-center">
                <h4 className="font-bold text-lg mb-1 text-gray-900 dark:text-white transition-colors group-hover:text-blue-600 dark:group-hover:text-blue-400">Email</h4>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="contact-card group relative cursor-pointer rounded-2xl overflow-hidden bg-white dark:bg-[#1B2731] shadow-lg hover:shadow-xl border border-gray-200 dark:border-gray-700 p-6 transition-all duration-300 hover:border-blue-600 dark:hover:border-blue-500 hover:-translate-y-2"
          >
            {/* Subtle gradient glow on hover */}
            ...
            <div className="relative flex flex-col items-center gap-4">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-600 to-blue-400 flex items-center justify-center shadow-md transition-transform duration-300 group-hover:scale-110 group-hover:shadow-lg">
                <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                </svg>
              </div>
              <div className="text-center">
                <h4 className="font-bold text-lg mb-1 text-gray-900 dark:text-white transition-colors group-hover:text-blue-600 dark:group-hover:text-blue-500">LinkedIn</h4>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="contact-card group relative cursor-pointer rounded-2xl overflow-hidden bg-white dark:bg-[#1B2731] shadow-lg hover:shadow-xl border border-gray-200 dark:border-gray-700 p-6 transition-all duration-300 hover:border-gray-900 dark:hover:border-gray-300 hover:-translate-y-2"
          >
            {/* Subtle gradient glow on hover */}
            <div className="absolute inset-0 bg-gradient-to-br from-gray-800/5 to-gray-600/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

            <div className="relative flex flex-col items-center gap-4">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-gray-800 to-gray-600 flex items-center justify-center shadow-md transition-transform duration-300 group-hover:scale-110 group-hover:shadow-lg">
                <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-center">
                <h4 className="font-bold text-lg mb-1 text-gray-900 dark:text-white transition-colors group-hover:text-gray-900 dark:group-hover:text-gray-300">GitHub</h4>
