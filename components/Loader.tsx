    ...
    <div ref={loadingRef} aria-hidden="true">
      <div className="white-bg fixed top-0 left-0 w-full h-screen bg-[#0e141a] z-[9999] flex justify-center items-center">
        <div className="overflow-hidden">
          <span className="loading-text inline-block text-bglight text-4xl sm:text-5xl lg:text-7xl tracking-widest">
            {children}
          </span>
        </div>
      </div>
      <div className="dark-bg fixed top-0 left-0 w-full h-screen bg-carrigreen z-[9998]"></div>
    </div>
  );
};
